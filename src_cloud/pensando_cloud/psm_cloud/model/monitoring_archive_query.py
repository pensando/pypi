...
class MonitoringArchiveQuery(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """MonitoringArchiveQuery - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            tenants ([str]): OR of tenants within the scope of which archive needs to be performed. If not specified, it will be set to tenant of the logged in user. Also users in non default tenant can archive logs in their tenant scope only.. [optional]  # noqa: E501
