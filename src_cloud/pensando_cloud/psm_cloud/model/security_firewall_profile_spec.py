...
class SecurityFirewallProfileSpec(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            tcp_close_timeout (str): TCP Close Timeout is the time for which TCP session is kept after a FIN is seen. Should be a valid time duration between 1s and 5m0s.. [optional] if omitted the server will use the default value of "15s"  # noqa: E501
