...
from pensando_cloud.psm.model.diagnostics_auto_msg_module_watch_helper_watch_event import DiagnosticsAutoMsgModuleWatchHelperWatchEvent
...
from pensando_cloud.psm.model.diagnostics_service_port import DiagnosticsServicePort
