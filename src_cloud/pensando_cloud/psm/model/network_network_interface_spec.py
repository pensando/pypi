...
class NetworkNetworkInterfaceSpec(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            attach_network (str): AttachNetwork associates the interface with a Network. This is only valid for host interfaces (host-pf/host-vf).. [optional]  # noqa: E501
            attach_tenant (str): [optional]  # noqa: E501
            connection_tracking (bool): ConnectionTracking enables connection tracking on the interface. This is valid only for host interfaces (host-pf/host-vf).. [optional] if omitted the server will use the default value of False  # noqa: E501
            enable_fw_logging (bool): EnableFwLogging enables flow logging on the interface. This is valid only for host interfaces (host-pf/host-vf).. [optional]  # noqa: E501
            ...
            vnf_attached (bool): VNFAttached knob on the interface. This is valid only for host interfaces (host-pf/host-vf).. [optional]  # noqa: E501
        """
