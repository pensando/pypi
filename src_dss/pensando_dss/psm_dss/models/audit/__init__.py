...
from pensando_dss.psm_dss.model.audit_audit_event_request import AuditAuditEventRequest
from pensando_dss.psm_dss.model.audit_event_attributes import AuditEventAttributes
