...
import time
import .psm_dss
from pensando_dss.psm_dss.api import fwlog_v1_api
from pensando_dss.psm_dss.model.api_object_meta import ApiObjectMeta
from pensando_dss.psm_dss.models.fwlog import *
from pensando_dss.psm_dss  import Configuration, ApiClient, ApiException
from dateutil.parser import parse as dateutil_parser
from pensando_dss.psm_dss.model.fwlog_fw_log_list import FwlogFwLogList
...
[[Back to psm_dss.FwlogV1Api top]](#psm_dss.FwlogV1Api) [[Back to fwlog README]](../psm_dss/docs/fwlog/README.md) [[Back to pensando_dss README]](../README.md)
...
with ApiClient() as api_client:
    ...
    vpc_names = [
        "vpc-names_example",
    ] # [str] | OR of vpc names to be matched. Only one vpc name is allowed. (optional)
...
from dateutil.parser import parse as dateutil_parser
from pensando_dss.psm_dss.model.fwlog_fw_log_list import FwlogFwLogList
from pensando_dss.psm_dss.model.fwlog_fw_log_query import FwlogFwLogQuery
from pprint import pprint
# Defining the host is optional and defaults to http://localhost
# See configuration.py for a list of all supported configuration parameters.
configuration = pensando_dss.psm_dss.Configuration(
