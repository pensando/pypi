...
class ApiObjectMeta(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """ApiObjectMeta - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            namespace (str): Namespace of the object, for scoped objects. Must start and end with alpha numeric and can have alphanumeric, -, _, . Length of string should be between 2 and 64.. [optional]  # noqa: E501
            resource_version (str): This is updated anytime there is any change to the object. System generated and updated, not updatable by user.. [optional]  # noqa: E501
            self_link (str): When the object is served from the API-GW it is the URI path. Example: - \"/v1/tenants/tenants/tenant2\" System generated and updated, not updatable by user.. [optional]  # noqa: E501
            tenant (str): This can be automatically filled in many cases based on the tenant the user, who created the object, belongs to. Must be alpha-numerics. Length of string should be between 1 and 48.. [optional]  # noqa: E501
            uuid (str): This is generated on creation of the object. System generated, not updatable by user.. [optional]  # noqa: E501
        """
