...
class NetworkTransceiverStatus(ModelNormal):
    ...
    allowed_values = {
        ...
        ('state',): {
            ...
            'SPROM_READ': "state_sprom_read",
            'SPROM_READ_ERR': "state_sprom_read_err",
        },
    }
    ...
    attribute_map = {
        'cable_type': 'cable-type',  # noqa: E501
        'pid': 'pid',  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """NetworkTransceiverStatus - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            cable_type (str): [optional] if omitted the server will use the default value of "none"  # noqa: E501
            pid (str): [optional] if omitted the server will use the default value of "unknown"  # noqa: E501
            state (str): [optional] if omitted the server will use the default value of "state_na"  # noqa: E501
        """
