...
class ApiTypeMeta(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """ApiTypeMeta - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            api_version (str): APIVersion defines the version of the API object. This can only be set by the server.. [optional]  # noqa: E501
