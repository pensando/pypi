...
class BulkeditBulkEditItem(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """BulkeditBulkEditItem - a model defined in OpenAPI
