...
class WorkloadWorkloadMigrationStatus(ModelNormal):
    ...
    allowed_values = {
        ('stage',): {
            ...
            'FINAL-SYNC': "migration-final-sync",
            'DONE': "migration-done",
            'ABORT': "migration-abort",
            'FROM-NON-PEN-HOST': "migration-from-non-pen-host",
        },
        ('status',): {
            'NONE': "none",
            'STARTED': "started",
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """WorkloadWorkloadMigrationStatus - a model defined in OpenAPI
