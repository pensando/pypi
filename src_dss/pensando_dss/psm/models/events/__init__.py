...
from pensando_dss.psm.model.events_event_attributes import EventsEventAttributes
...
from pensando_dss.psm.model.events_get_event_request import EventsGetEventRequest
