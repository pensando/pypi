...
from pensando_dss.psm.model.diagnostics_module_spec import DiagnosticsModuleSpec
from pensando_dss.psm.model.diagnostics_module_status import DiagnosticsModuleStatus
